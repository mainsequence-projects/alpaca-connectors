...
class AlpacaBarsSupportTests(unittest.TestCase):
    ...
    def test_resolve_asset_bindings_uses_figi_fallback_ticker(self) -> None:
        class StubAsset:
            def __init__(self):
                self.unique_identifier = "BBG000BJKPG0"
        ...
        self.assertEqual(bindings[0].alpaca_symbol, "FISV")
        self.assertEqual(bindings[0].unique_identifier, "BBG000BJKPG0")
