...
def fetch_page_html_with_playwright(
    ...
    *,
    ...
    try:
        ...
        raise RuntimeError(
            "Playwright is not installed. Install the project dependencies and browser runtime "
            "before using browser-backed extractors."
        ) from exc
        ...
        with sync_playwright() as playwright:
            ...
            try:
                ...
                try:
                    ...
                    # Some provider pages keep background requests open indefinitely.
                    # The rendered DOM is still usable once the target content is visible.
                    pass
                return page.content()
            finally:
                browser.close()
